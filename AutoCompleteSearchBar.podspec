#
#  Be sure to run `pod spec lint AutoCompleteSearchBar.podspec' to ensure this is a
...
s.description  = "AutoCompleteSearchBar is a subclass of UISeachBar which supports the autocomplete feature including:
...
- Compact mode(compact mode is minimized the results list frame, default is off)"
  ...
  # Or just: s.author    = "ShengRong"
  # s.authors            = { "ShengRong" => "aimbebe.r@gmail.com" }
  # s.social_media_url   = "http://twitter.com/ShengRong"
